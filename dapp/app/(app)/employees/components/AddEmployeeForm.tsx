...
export default function AddEmployeeForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (Number(amountUSD) < 1) {
      alert("Salary must be at least $1");
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all"
              placeholder="5000.00"
              required
            />
        </div>
      ...
      <button
        disabled={isSubmitting || !firstName || !address || !amountUSD}

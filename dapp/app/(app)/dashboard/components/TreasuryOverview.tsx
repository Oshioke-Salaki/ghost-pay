      ...
      <div className="flex flex-col items-start md:flex-row md:justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 max-w-lg leading-relaxed">
            ...
            <strong
              className={
                viewMode === "private" ? "text-purple-700" : "text-black"
              }
            >
              {viewMode}
            </strong>{" "}
            token balances currently available in your{" "}
            {viewMode === "private"
              ? "shielded Ghost Vault"
              : "public Starknet wallet"}
            .
            {viewMode === "private" &&
              " Balances here are encrypted and invisible on-chain."}
          </p>
        </div>

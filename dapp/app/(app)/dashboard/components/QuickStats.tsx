    ...
    const loadGlobalStats = async () => {
      ...
      try {
        ...
        if (allEmployees) {
          ...
          const totalPay = allEmployees.reduce((sum, e) => {
             // Handle numeric or string
             const val = Number(e.salary_usd) || 0;
             return sum + val;
          }, 0);
        ...
        <div>
          ...
          >
            {loadingStats ? (
              ...
              <>
                ${globalStats.totalPayroll.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
